...
public class EvaluationService {
	 ...
	 * reverses a Stringa. Example: reverse("example"); -> "elpmaxe"
	 * 
	 * @param string
	 * @return
	 */
...
//	}
	...
	public String reverseMe(String string) {
		char[] reversedArr = new char[string.length()];
		for (int i = reversedArr.length - 1, j = 0; i >= 0; i--, j++) {
			reversedArr[j] += string.charAt(i);
		}
	 ...
	 * 
	 * @param phrase
	 * @return public String acronym(String phrase) { // TODO Write an
	 *         implementation for this method declaration return null; }
	 */

	public String acronym(String phrase) {
System.out.println(phrase.length());
		char[] newChar = new char[phrase.length()];
...
//	String[] space1 = {" "};  
		...
		for (int i = 0; i <= phrase.length() - 1; i++) {
			if (phrase.toString() != space) { /// STUCK
				newChar[i] += phrase.charAt(i);
