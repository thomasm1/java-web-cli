...
public class EvaluationServiceTest {
	...
	public void testAnEmptyString() {
		assertEquals("retcarahc", evaluationService.reverseMe("character"));
	...
	public void testACapitalizedWord() {
		assertEquals("nemaR", evaluationService.reverseMe("Ramen"));
	}

	@Test
	public void testASentenceWithPunctuation() {
		assertEquals("!yrgnuh m'I", evaluationService.reverseMe("I'm hungry!"));
	}

	@Test
	public void testAPalindrome() {
		assertEquals("racecar", evaluationService.reverseMe("racecar"));
	}
//
//	/*******************************************************************
//	 * Question 2
...
//		 Triangle triangle = new Triangle(5, 4, 6); 
		assertFalse(evaluationService.isEquilateral(5.0, 4.0, 6.0));
	}
	@Test
	public void verySmallTrianglesCanBeEquilateral() {
		assertTrue(evaluationService.isEquilateral(0.5, 0.5, 0.5));
	}
	@Test
	public void isoscelesTrianglesMustHaveAtLeastTwoEqualSides() { 
		assertFalse(evaluationService.isIsosceles(0.5, 0.5, 0.5));
	}
	@Test
	public void verySmallTrianglesCanBeIsosceles() {
		assertTrue(evaluationService.isIsosceles(0.5, 0.5, 0.5));
	}
	@Test
	public void trianglesWithAllSidesEqualAreNotScalene() {
		assertFalse(evaluationService.isScalene(0.5, 0.5, 0.5));
	}
	@Test
	public void verySmallTrianglesCanBeScalene() {
		assertTrue(evaluationService.isScalene(0.5, 0.5, 0.5));
	}
//	/*******************************************************************
//	 * Question 4
//	 ******************************************************************/
